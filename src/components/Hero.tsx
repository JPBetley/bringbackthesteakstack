...
import coverImage from '@/images/steakstack-2.png'
    ...
    <figure className="relative mx-auto max-w-md text-center lg:mx-0 lg:text-left">
      ...
      <blockquote className="mt-2">
        <p className="font-display text-xl font-medium text-slate-900">
          “The day we got the steak stack, I cried of happiness.
          The day we lost it, I cried in sorrow.”
        </p>
      </blockquote>
      <figcaption className="mt-2 text-sm text-slate-500">
        ...
        , Founder of Bring Back the Steak Stack
      </figcaption>
    </figure>
  )
}
    ...
    <header className="overflow-hidden bg-slate-100 lg:bg-transparent lg:px-5">
      <div className="mx-auto grid max-w-6xl grid-cols-1 grid-rows-[auto_1fr] gap-y-16 pt-16 md:pt-20 lg:grid-cols-12 lg:gap-y-20 lg:px-3 lg:pb-36 lg:pt-20 xl:py-32">
        <div className="relative flex items-end lg:col-span-5 lg:row-span-2">
          ...
          <div className="relative z-10 mx-auto flex w-64 rounded-xl bg-slate-600 shadow-xl md:w-[30rem] lg:w-[60rem]">
